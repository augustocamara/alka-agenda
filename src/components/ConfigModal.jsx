...
export default function ConfigModal({ aberto, onFechar, onImportar, onExportar, canInstall, install, isStandalone, show }) {
        ...
        {iosInstructions && (
          <div style={{ background: '#0f172a', borderRadius: 12, padding: 16, marginBottom: 16, border: '1px solid #6366f1' }}>
            ...
            <ol style={{ color: '#94a3b8', fontSize: 13, paddingLeft: 18, lineHeight: 1.8 }}>
              <li>Toque em <strong style={{ color: '#f1f5f9' }}>Compartilhar</strong> (ícone de quadrado com seta ↑)</li>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          {!isStandalone && (
            <BtnItem
              ...
              desc={canInstall ? 'Adicionar à tela inicial (Android/Chrome)' : isIos ? 'Ver instruções para iPhone' : 'Abra no Chrome ou Safari para instalar'}
              cor="#6366f1"
          ...
          <BtnItem
            ...
            desc="Carregue o arquivo exportado da agenda antiga"
            cor="#f59e0b"
          ...
          <BtnItem
            ...
            desc="Salva todas as despesas em JSON"
            cor="#10b981"
            onClick={onExportar}
          />
